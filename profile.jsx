...
const Profile = (props) => {
	...
	useEffect(() => {
		axios.get(global.config.apiurl + `uploadimg/countimgs`, {withCredentials: true}).then((res) => {
			let alldata = res.data;
			// alert(alldata[0].totalimgs);
			setTotalimgs(alldata[0].totalimgs);
		});
		axios.get(global.config.apiurl + `uploadimg/countcontests`, {withCredentials: true}).then((res) => {
			let alldata = res.data;
			// console.log(alldata);
				...
				<div className='Wrapper-div'>
					<header className='card-header'>
						<div className='inner-div'>
							<img className='user_pic' src='https://media.visualstories.com/uploads/images/1/140/5430023-960_468357488-1158103_p.jpg' alt='' />
