...
// 					this.state.openEntry.entryDate.month &&
// 				this.state.present.getFullYear() ===
// 					this.state.openEntry.entryDate.year
// 			) {
// 				daysBetween = 'Today';
// 			}
...
// 								className="entry_img"
// 								style={{
// 									backgroundColor: this.state.openEntry
// 										.entryColor.color,
// 								}}>
...
// 							aria-hidden="true"
// 							onClick={this.update.bind(null, 'left')}></i>
// 						<i
// 							className="fa fa-arrow-right"
// 							aria-hidden="true"
// 							onClick={this.update.bind(null, 'right')}></i>
// 					</div>
// 					<div id="dates">
// 						{calendar.map(
// 							function (week, i) {
...
// 																onClick={this.openEntry.bind(
// 																	null,
// 																	entry,
// 																	e
// 																)}>
// 																<p className="entry_event">
// 																	{
// 																		entry.entryName
// 																	}
// 																</p>
